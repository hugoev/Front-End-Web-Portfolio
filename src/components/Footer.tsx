              ...
              <div className="flex space-x-4">
                {links.social.map((item) => (
                  <motion.a
                    ...
                    className="p-2 bg-[#1A1A1A] rounded-lg text-gray-400 hover:text-blue-400 border border-blue-500/10 hover:border-blue-500/20 transition-colors duration-300"
                  >
                    {item.icon}
                  </motion.a>
                ))}
